...
Open weaknesses:
- CWE-502: Unsafe YAML deserialization is prevented with yaml.safe_load()
...
def load_flags(flags_file: Optional[str] = None) -> None:
    ...
    CWE-502: yaml.safe_load() prevents arbitrary Python object
    deserialisation from attacker-controlled YAML.
    """
    global _flags
